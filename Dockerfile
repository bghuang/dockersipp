...
RUN apt-get update && \
    apt-get install -y --no-install-recommends build-essential apt-utils pkg-config libtool openssl help2man curl automake ncurses-dev libgsl0-dev libsctp-dev libpcap-dev libssl-dev
